...
import 'package:flutter_bluetooth_app/Bannercard.dart';
import 'package:flutter_bluetooth_app/Cards.dart';
import 'package:flutter_feather_icons/flutter_feather_icons.dart';
import 'package:hexcolor/hexcolor.dart';

bool Card_color_change = false;

class Main_card extends StatefulWidget {
  const Main_card({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    return Expanded(
      child: Container(
        ...
        height: 10,
        // color: Color.fromARGB(255, 230, 152, 17),
        child: Column(
          children: [
            Padding(

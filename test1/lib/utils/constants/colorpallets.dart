...
class TheamColors with ChangeNotifier {
  ...
  static Color unselectedChipColor = const Color.fromARGB(255, 206, 206, 206);
  ...
  static Color PtexrtColor1 = const Color.fromARGB(221, 45, 45, 45);
  static Color HtexrtColor2 = Color.fromARGB(255, 126, 126, 126);
  static Color PtexrtColor2 = const Color.fromARGB(255, 255, 255, 255);

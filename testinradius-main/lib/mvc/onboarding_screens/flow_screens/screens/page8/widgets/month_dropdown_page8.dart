...
class monthDropdownPage8 extends StatelessWidget {
  List dataList;
  String hintText;
  ...
  Widget build(BuildContext context) {
    ...
    return Consumer<Page8Controller>(
      builder:
        ...
        return InkWell(
          onTap: () {
            page8Value.openCloseDropdownMonthState =
                !page8Value.openCloseDropdownMonthState;
          },
          child: Column(
            children: <Widget>[
                ...
                child: Row(
                  ...
                  children: [
                    Container(
                      ...
                      child: Text(
                        page8Value.userExperienceInMonth == 0
                            ? hintText
                            : page8Value.userExperienceInMonth.toString(),
              ...
              Container(
                  width: width * 0.36,
                  height: page8Value.openCloseDropdownMonthState == true
                      ? height * 0.18
                      : 0,
                  decoration: BoxDecoration(
                      borderRadius:const BorderRadius.all(Radius.circular(10)),
                  ...
                  child: ListView.builder(
                    ...
                    itemBuilder: (BuildContext context, int index) {
                      ...
                      return ListTile(
                        ...
                        onTap: () {
                          page8Value.userExperienceInMonth = item;
                          page8Value.openCloseDropdownMonthState =
                              !page8Value.openCloseDropdownMonthState;
                        },
                      );
